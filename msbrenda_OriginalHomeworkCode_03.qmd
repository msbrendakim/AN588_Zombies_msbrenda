...
-   **Zombies Killed & Education**: Not normal! They’re discrete and skewed—maybe Bernoulli-like, since they’re counts.
...
set.seed(999)
samp_means <- list(
  height = replicate(100, mean(sample(z$height, 30))),
  weight = replicate(100, mean(sample(z$weight, 30))),
  age = replicate(100, mean(sample(z$age, 30))),
  zombies_killed = replicate(100, mean(sample(z$zombies_killed, 30))),
  education = replicate(100, mean(sample(z$years_of_education, 30)))
)
```
...
-   How do the standard deviations of means compare to the standard errors estimated in \[5\]?
    ...
    -   Height: Task 5 SE = 0.795, here it's 0.657

    -   Weight: Task 5 SE = 3.6, here it's 3.56

    -   Age: Task 5 SE = 0.441, here it's 0.564

    -   Zombies Killed: Task 5 SE = 0.328, here it's 0.315

    -   Years of Education: Task 5 SE = 0.269, here it's 0.358

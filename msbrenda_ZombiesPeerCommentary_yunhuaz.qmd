...
*T.Z: Received the same values! Love the step by step, but this can also be simplified through a for loop since you created a function!*
...
*T.Z: Really liked how you broke it down you code. It is very nice and easy to read. I really love the color usage in the graphs. Really love the use of tibble throughout your code. I love the explanation at the end and it is very cohesive. I think you can also explain what each descriptive data meant after the first question. Other than that great code! Don't forget to add a gif in the beginning and I believe there is a way we need to edit the theme (readdown).*
